...
class Unit : public WorldObject
{
    public:
		...
		uint32 GetCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_CRIT_TAKEN, 1.2f, 9.0f, damage); } // Not use in Cataclysm
