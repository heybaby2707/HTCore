...
class Unit : public WorldObject
{
    public:
		...
		uint32 GetCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_CRIT_TAKEN, 2.2f, 33.0f, damage); } // Not use in Cataclysm
