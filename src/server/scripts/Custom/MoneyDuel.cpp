		...
		switch(uiSender)
		{
			...
			case 11:
				if (USE_TOKEN)
				{
					...
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, "Bet 1000 tokens", GOSSIP_SENDER_MAIN, 1000, "Type in the player's name", 0, true);
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, "Bet 2000 tokens", GOSSIP_SENDER_MAIN, 2000, "Type in the player's name", 0, true);
				}
				else
				{
					...
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, "Bet 1000g", GOSSIP_SENDER_MAIN, 1000, "Type in the player's name", 0, true);
					player->ADD_GOSSIP_ITEM_EXTENDED(GOSSIP_ICON_MONEY_BAG, "Bet 2000g", GOSSIP_SENDER_MAIN, 2000, "Type in the player's name", 0, true);
				}
