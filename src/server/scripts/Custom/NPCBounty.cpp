...
#define BOUNTY_4 "I would like to place a 2000g bounty."
#endif
#if SET_CURRENCY == 1 //TODO
#define BOUNTY_1 "I would like to place a 200 honor bounty."
#define BOUNTY_2 "I would like to place a 400 honor bounty."
				...
				if(passChecks(pPlayer, code))
				{
					...
					switch (uiAction)
					{
						case GOSSIP_ACTION_INFO_DEF+5:
						{
							...
							{
								#if SET_CURRENCY != 2
								CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u','200', '1')", pBounty->GetGUID());
								#else
						...
						case GOSSIP_ACTION_INFO_DEF+6:
						{
							...
							{
								#if SET_CURRENCY != 2
								CharacterDatabase.PExecute("INSERT INTO bounties VALUES('%u', '400', '2')", pBounty->GetGUID());
								#else
...
class BountyKills : public PlayerScript
{
	public:
		...
		void OnPVPKill(Player* killer, Player* killed)
		{
			...
			QueryResult result = CharacterDatabase.PQuery("SELECT * FROM bounties WHERE guid='%u'", killed->GetGUID());
			if(!result)
				return;
